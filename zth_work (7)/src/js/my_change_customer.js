window.onload=function () {
    ...
    var register_cos=document.querySelector("#register_cos");//客户修改
            ...
            $.ajax({
                ...
                success: function (result, status, xhr) {//xhr   xmlHttpRequest
                    ...
                    if (result.statusCode == "200") {
                        ...
                        document.getElementById("sfzh").setAttribute("value",result.dataZone.customer.customerId);
                        document.getElementById("khxm").setAttribute("value",result.dataZone.customer.name);
                        document.getElementById("sjh").setAttribute("value",result.dataZone.customer.sex);
                        document.getElementById("xb").setAttribute("value",result.dataZone.customer.phoneNum);
                        document.getElementById("zk").setAttribute("value",result.dataZone.customer.discount);
                        alert(result.message);
